...
public class LabelController {
    ...
    @RequestMapping(value = "api/verifycomment", method = RequestMethod.POST)
    public ResponseEntity<?> verify(String article_id, String comment_address) {
    ...
    @RequestMapping(value = "api/labelcomment", method = RequestMethod.POST)
